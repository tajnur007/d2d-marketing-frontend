...
function Item(data: Person[]){
    return (

        <>
             {data.map((person)=>
          (
            <div key={person.id} className={`relative w-[245px] h-[43px] mt-[16px] left-[25px]`}>
            ...
            <div className={`w-[${person.name.length * 8}px] absolute h-[31px] top-[6px] left-[70px]`}>
