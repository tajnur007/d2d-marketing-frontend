...
import { AssignSelectProps } from '@/models/global-types';
...
export const AssignToSelect = ({
  ...
  // Filter options to show only those with public: true
  const filteredOptions = options.filter((option) => option.isPublic);
