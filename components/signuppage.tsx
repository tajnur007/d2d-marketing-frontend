...
const Signupform = () => {
  ...
  return (
    <div className="w-[1440px] h-[900px] relative bg-white">
      ...
      <div className="left-[886px] top-[133px] absolute text-black text-2xl font-semibold ">Get Started With D2D</div>
      <div className="left-[931px] top-[167px] absolute text-zinc-500 text-[15.04px] font-normal  leading-[10.90px]">Getting started is easy</div>
      <div>

        <div className="left-[810px] top-[284px] absolute text-black text-[13px] font-normal font-['Poppins'] leading-[14.50px]"><Vectorline /></div>
        <div className="left-[957px] top-[277px] absolute text-black text-[13px] font-normal font-['Poppins'] leading-[14.50px]">Or continue with</div>
        <div className="left-[1080px] top-[284px] absolute text-black text-[13px] font-normal font-['Poppins'] leading-[14.50px]"><Vectorline /></div>
      ...
      <div className="h-[77px] left-[816px] top-[407px] absolute flex-col justify-start items-start gap-2 inline-flex">
        ...
        <div className="w-[400px] px-3 py-[15.50px] bg-white rounded-[10px] border border-zinc-100 justify-start items-center gap-5 inline-flex">
          <div className="grow shrink basis-0 h-6 justify-start items-start gap-3 flex">
            <input
              ...
              className="w-[80%] px-2 py-  focus:outline-none focus:ring"
            />
          </div>
      ...
      <div className="w-[400px] h-[57.75px] left-[816px] top-[685px] absolute">
        ...
        >
          <div className="left-[144px] top-[23px] absolute text-black text-[14.85px] font-semibold  leading-3">Create Account</div>
        </button>
      </div>
    </div>
  );
