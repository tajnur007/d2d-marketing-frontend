  ...
  return (
    <div>
      <div className="w-[1440px] h-[900px] relative bg-white">
        ...
        <div className="left-[929px] top-[234px] absolute text-black text-lg font-normal leading-[29.16px]">Login into your account</div>
        <div className="left-[898px] top-[184px] absolute text-black text-4xl font-semibold  leading-[44px]">Welcome Back</div>
      </div>
    </div>
  );
};
